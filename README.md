...
Generated plot and TSV files are available in `plot` directory as samples.
```
mkdir -p data
...
```
Allow training to run for at least a few hours, till a few checkpoints with CER less than 10% are generated, 
